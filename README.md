...
Por ello, contar con una herramienta que prediga el ADR óptimo basado en características reales de una reserva permite tomar mejores decisiones comerciales y mejorar el rendimiento financiero.


Este proyecto ha sido desarrollado como trabajo académico para fines de aprendizaje y evaluación universitaria.
Su objetivo es demostrar el flujo completo de análisis de datos, Machine Learning y desarrollo de API web, y no está pensado para uso en producción.
